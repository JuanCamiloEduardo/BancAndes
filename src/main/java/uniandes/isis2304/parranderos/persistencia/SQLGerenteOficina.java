...
class SQLGerenteOficina {
	 ...
	 */
	public long adicionarGerenteOficina (PersistenceManager pm, long idTipoBebida, String nombre,String login,String clave,long numeroDocumento,String tipoDocumento,String nacionalidad,String direccionFisica,String direccionElectronica,long telefono,String ciudad,String departamento,long codigoPostal) 
	{
	...
	public List<GerenteOficina> darTipoGerenteOficina (PersistenceManager pm,String login, String clave)
	{	
		Query q = pm.newQuery(SQL, "SELECT * FROM " + pp.darTablaGerenteOficina  () + " WHERE login = ? AND clave = ?");
