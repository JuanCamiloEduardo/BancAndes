...
ALTER TABLE OPERACIONES
    ADD CONSTRAINT OPERACIONES_FK_1
    FOREIGN KEY (CONSIGNADOR) REFERENCES USUARIO(LOGIN)
ENABLE;

ALTER TABLE OPERACIONES
    ADD CONSTRAINT OPERACIONES_FK_2
    FOREIGN KEY (DESTINATARIO) REFERENCES USUARIO(LOGIN)
ENABLE;

ALTER TABLE OPERACIONES
    ADD CONSTRAINT OPERACIONES_FK_3
    FOREIGN KEY (IDCONSIGNADOR) REFERENCES CUENTA(ID)
ENABLE;

ALTER TABLE OPERACIONES
    ADD CONSTRAINT OPERACIONES_FK_4
    FOREIGN KEY (IDDESTINATARIO) REFERENCES CUENTA(ID)
ENABLE;
